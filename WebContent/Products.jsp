...
<%
	...
	if (failure != null && failure.equals("InsertProduct")) {
%>
	Data insertion failure<p>
<%
	} else if (failure != null && failure.equals("UpdateProduct")) {
%>
	Data modification failure<p>
<%
	} else if (failure != null && failure.equals("DeleteProduct")) {
%>
		...
		<table>
		    ...
		    <tr>
                <form action="Products.jsp" method="POST">
                    ...
                    <th>&nbsp;</th>
                    <th><input value="" name="I_product_name" required/></th>
                    <th>
                    ...
                    <th><input value="" name="I_sku" required/></th>
                    <th><input type="number" step=0.01 value="" name="I_price" required/></th>
                    <th><input type="submit" value="Insert" required/></th>
                </form>
            </tr>
		    ...
		    <tr>
		        <form action="Products.jsp" method="POST">
		            ...
		            <%-- Get the name --%>
		            <td>
		                <input value="<%=rs.getString(2)%>" name="I_product_name" required/>
		            </td>
		            <%-- Get the category --%>
		            <td>
                    <select name="I_Category_id">
		             ...
		             <%-- Get the sku --%>
		            <td>
		                <input value="<%=rs.getString(3)%>" name="I_sku" required/>
		            </td>  
		            <%-- Get the price --%>
		            <td>
		                <input type="number" step=0.01 value="<%=rs.getDouble(4)%>" name="I_price" required/>
		            </td>    
